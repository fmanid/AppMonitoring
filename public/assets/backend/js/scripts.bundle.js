        ...
        */
        ...
        var KTLayoutChat = function () {
          ...
          var _handeMessaging = function(element) {
            ...
            html += '	</div>';
            html += '</div>';
            html += '<div class="mt-2 rounded p-5 bg-light-primary text-dark-50 font-weight-bold font-size-lg text-right max-w-400px"> Test ' + textarea.value + '</div>';
            ...
            setTimeout(function() {
              ...
              html += 'asd Right before vacation season we have the next Big Deal for you.';
              html += '</div>';
